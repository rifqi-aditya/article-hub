        ...
        <div class="card shadow-lg border-light rounded">
            ...
            <div class="card-body">
                ...
                <?php if (!empty($article['image'])): ?>
                    <img src="<?= base_url('uploads/' . esc($article['image'])) ?>" class="img-fluid rounded mb-4 shadow-sm" alt="Artikel Image">
                <?php else: ?>
                    <img src="https://via.placeholder.com/800x400" class="img-fluid rounded mb-4 shadow-sm" alt="No Image Available">
                <?php endif; ?>

                <!-- Konten Artikel: Wrap each paragraph with <p> -->
                <?php
                    $content = nl2br(esc($article['content'])); // Convert newlines to <br> tags
                    $content = preg_replace('/(<br\s*\/?>(\s*<br\s*\/?>)+)/', '</p><p>', $content); // Convert multiple breaks to <p> tags
                    echo "<p>{$content}</p>";
                ?>
            </div>
            ...
            <div class="card-footer text-muted">
                ...
                <div class="mt-3 text-center">
                    <a href="<?= base_url('articles/edit/' . $article['id']) ?>" class="btn btn-warning me-2 btn-lg">
                        <i class="bi bi-pencil-square"></i> Edit
                    </a>
                    <!-- Tombol Delete (Trigger Modal) -->
                    <button class="btn btn-danger btn-lg" data-bs-toggle="modal" data-bs-target="#deleteModal">
